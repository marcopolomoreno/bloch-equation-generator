...
int main() {
	...
	double A28 = freqRabi;
	double A39 = freqRabi;
	double A410 = freqRabi;
	double A511 = freqRabi;
    ...
    {
		/*a11*/ if (j == 0) return - 2*a17*B17 + 2*b17*A17 + Gamma61*a66 + Gamma71*a77 + Gamma81*a88;
		/*a22*/ if (j == 1) return - 2*a28*B28 + 2*b28*A28 + Gamma72*a77 + Gamma82*a88 + Gamma92*a99;
		/*a33*/ if (j == 2) return - 2*a39*B39 + 2*b39*A39 + Gamma83*a88 + Gamma93*a99 + Gamma103*a1010;
		/*a44*/ if (j == 3) return - 2*a410*B410 + 2*b410*A410 + Gamma94*a99 + Gamma104*a1010 + Gamma114*a1111;
		/*a55*/ if (j == 4) return - 2*a511*B511 + 2*b511*A511 + Gamma105*a1010 + Gamma115*a1111 + Gamma125*a1212;
		/*a66*/ if (j == 5) return - Gamma61*a66;
		/*a77*/ if (j == 6) return + 2*a17*B17 - 2*b17*A17 - Gamma71*a77 - Gamma72*a77;
		/*a88*/ if (j == 7) return + 2*a28*B28 - 2*b28*A28 - Gamma81*a88 - Gamma82*a88 - Gamma83*a88;
		/*a99*/ if (j == 8) return + 2*a39*B39 - 2*b39*A39 - Gamma92*a99 - Gamma93*a99 - Gamma94*a99;
		/*a1010*/ if (j == 9) return + 2*a410*B410 - 2*b410*A410 - Gamma103*a1010 - Gamma104*a1010 - Gamma105*a1010;
		/*a1111*/ if (j == 10) return + 2*a511*B511 - 2*b511*A511 - Gamma114*a1111 - Gamma115*a1111;
		/*a1212*/ if (j == 11) return - Gamma125*a1212;
		/*a12*/ if (j == 12) return -gamma12*a12 - delta21*b12 - a27*B17 + b27*A17 - a18*B28 + b18*A28;
		/*b12*/ if (j == 13) return -gamma12*b12 + delta21*a12 + a27*A17 + b27*B17 - a18*A28 - b18*B28;
		/*a13*/ if (j == 14) return -gamma13*a13 - delta31*b13 - a37*B17 + b37*A17 - a19*B39 + b19*A39;
		/*b13*/ if (j == 15) return -gamma13*b13 + delta31*a13 + a37*A17 + b37*B17 - a19*A39 - b19*B39;
		/*a14*/ if (j == 16) return -gamma14*a14 - delta41*b14 - a47*B17 + b47*A17 - a110*B410 + b110*A410;
		/*b14*/ if (j == 17) return -gamma14*b14 + delta41*a14 + a47*A17 + b47*B17 - a110*A410 - b110*B410;
		/*a15*/ if (j == 18) return -gamma15*a15 - delta51*b15 - a57*B17 + b57*A17 - a111*B511 + b111*A511;
		/*b15*/ if (j == 19) return -gamma15*b15 + delta51*a15 + a57*A17 + b57*B17 - a111*A511 - b111*B511;
		/*a16*/ if (j == 20) return -gamma16*a16 - delta61*b16 - a67*B17 + b67*A17;
		/*b16*/ if (j == 21) return -gamma16*b16 + delta61*a16 + a67*A17 + b67*B17;
		/*a17*/ if (j == 22) return -gamma17*a17 - delta71*b17 - B17*(a77 - a11);
		/*b17*/ if (j == 23) return -gamma17*b17 + delta71*a17 + A17*(a77 - a11);
		/*a18*/ if (j == 24) return -gamma18*a18 - delta81*b18 + a12*B28 + b12*A28 - a78*B17 - b78*A17;
		/*b18*/ if (j == 25) return -gamma18*b18 + delta81*a18 - a12*A28 + b12*B28 + a78*A17 - b78*B17;
		/*a19*/ if (j == 26) return -gamma19*a19 - delta91*b19 + a13*B39 + b13*A39 - a79*B17 - b79*A17;
		/*b19*/ if (j == 27) return -gamma19*b19 + delta91*a19 - a13*A39 + b13*B39 + a79*A17 - b79*B17;
		/*a110*/ if (j == 28) return -gamma110*a110 - delta101*b110 + a14*B410 + b14*A410 - a710*B17 - b710*A17;
		/*b110*/ if (j == 29) return -gamma110*b110 + delta101*a110 - a14*A410 + b14*B410 + a710*A17 - b710*B17;
		/*a111*/ if (j == 30) return -gamma111*a111 - delta111*b111 + a15*B511 + b15*A511 - a711*B17 - b711*A17;
		/*b111*/ if (j == 31) return -gamma111*b111 + delta111*a111 - a15*A511 + b15*B511 + a711*A17 - b711*B17;
		/*a112*/ if (j == 32) return -gamma112*a112 - delta121*b112 - a712*B17 - b712*A17;
		/*b112*/ if (j == 33) return -gamma112*b112 + delta121*a112 + a712*A17 - b712*B17;
		/*a23*/ if (j == 34) return -gamma23*a23 - delta32*b23 - a38*B28 + b38*A28 - a29*B39 + b29*A39;
		/*b23*/ if (j == 35) return -gamma23*b23 + delta32*a23 + a38*A28 + b38*B28 - a29*A39 - b29*B39;
		/*a24*/ if (j == 36) return -gamma24*a24 - delta42*b24 - a48*B28 + b48*A28 - a210*B410 + b210*A410;
		/*b24*/ if (j == 37) return -gamma24*b24 + delta42*a24 + a48*A28 + b48*B28 - a210*A410 - b210*B410;
		/*a25*/ if (j == 38) return -gamma25*a25 - delta52*b25 - a58*B28 + b58*A28 - a211*B511 + b211*A511;
		/*b25*/ if (j == 39) return -gamma25*b25 + delta52*a25 + a58*A28 + b58*B28 - a211*A511 - b211*B511;
		/*a26*/ if (j == 40) return -gamma26*a26 - delta62*b26 - a68*B28 + b68*A28;
		/*b26*/ if (j == 41) return -gamma26*b26 + delta62*a26 + a68*A28 + b68*B28;
		/*a27*/ if (j == 42) return -gamma27*a27 - delta72*b27 + a12*B17 - b12*A17 - a78*B28 + b78*A28;
		/*b27*/ if (j == 43) return -gamma27*b27 + delta72*a27 - a12*A17 - b12*B17 + a78*A28 + b78*B28;
		/*a28*/ if (j == 44) return -gamma28*a28 - delta82*b28 - B28*(a88 - a22);
		/*b28*/ if (j == 45) return -gamma28*b28 + delta82*a28 + A28*(a88 - a22);
		/*a29*/ if (j == 46) return -gamma29*a29 - delta92*b29 + a23*B39 + b23*A39 - a89*B28 - b89*A28;
		/*b29*/ if (j == 47) return -gamma29*b29 + delta92*a29 - a23*A39 + b23*B39 + a89*A28 - b89*B28;
		/*a210*/ if (j == 48) return -gamma210*a210 - delta102*b210 + a24*B410 + b24*A410 - a810*B28 - b810*A28;
		/*b210*/ if (j == 49) return -gamma210*b210 + delta102*a210 - a24*A410 + b24*B410 + a810*A28 - b810*B28;
		/*a211*/ if (j == 50) return -gamma211*a211 - delta112*b211 + a25*B511 + b25*A511 - a811*B28 - b811*A28;
		/*b211*/ if (j == 51) return -gamma211*b211 + delta112*a211 - a25*A511 + b25*B511 + a811*A28 - b811*B28;
		/*a212*/ if (j == 52) return -gamma212*a212 - delta122*b212 - a812*B28 - b812*A28;
		/*b212*/ if (j == 53) return -gamma212*b212 + delta122*a212 + a812*A28 - b812*B28;
		/*a34*/ if (j == 54) return -gamma34*a34 - delta43*b34 - a49*B39 + b49*A39 - a310*B410 + b310*A410;
		/*b34*/ if (j == 55) return -gamma34*b34 + delta43*a34 + a49*A39 + b49*B39 - a310*A410 - b310*B410;
		/*a35*/ if (j == 56) return -gamma35*a35 - delta53*b35 - a59*B39 + b59*A39 - a311*B511 + b311*A511;
		/*b35*/ if (j == 57) return -gamma35*b35 + delta53*a35 + a59*A39 + b59*B39 - a311*A511 - b311*B511;
		/*a36*/ if (j == 58) return -gamma36*a36 - delta63*b36 - a69*B39 + b69*A39;
		/*b36*/ if (j == 59) return -gamma36*b36 + delta63*a36 + a69*A39 + b69*B39;
		/*a37*/ if (j == 60) return -gamma37*a37 - delta73*b37 + a13*B17 - b13*A17 - a79*B39 + b79*A39;
		/*b37*/ if (j == 61) return -gamma37*b37 + delta73*a37 - a13*A17 - b13*B17 + a79*A39 + b79*B39;
		/*a38*/ if (j == 62) return -gamma38*a38 - delta83*b38 + a23*B28 - b23*A28 - a89*B39 + b89*A39;
		/*b38*/ if (j == 63) return -gamma38*b38 + delta83*a38 - a23*A28 - b23*B28 + a89*A39 + b89*B39;
		/*a39*/ if (j == 64) return -gamma39*a39 - delta93*b39 - B39*(a99 - a33);
		/*b39*/ if (j == 65) return -gamma39*b39 + delta93*a39 + A39*(a99 - a33);
		/*a310*/ if (j == 66) return -gamma310*a310 - delta103*b310 + a34*B410 + b34*A410 - a910*B39 - b910*A39;
		/*b310*/ if (j == 67) return -gamma310*b310 + delta103*a310 - a34*A410 + b34*B410 + a910*A39 - b910*B39;
		/*a311*/ if (j == 68) return -gamma311*a311 - delta113*b311 + a35*B511 + b35*A511 - a911*B39 - b911*A39;
		/*b311*/ if (j == 69) return -gamma311*b311 + delta113*a311 - a35*A511 + b35*B511 + a911*A39 - b911*B39;
		/*a312*/ if (j == 70) return -gamma312*a312 - delta123*b312 - a912*B39 - b912*A39;
		/*b312*/ if (j == 71) return -gamma312*b312 + delta123*a312 + a912*A39 - b912*B39;
		/*a45*/ if (j == 72) return -gamma45*a45 - delta54*b45 - a510*B410 + b510*A410 - a411*B511 + b411*A511;
		/*b45*/ if (j == 73) return -gamma45*b45 + delta54*a45 + a510*A410 + b510*B410 - a411*A511 - b411*B511;
		/*a46*/ if (j == 74) return -gamma46*a46 - delta64*b46 - a610*B410 + b610*A410;
		/*b46*/ if (j == 75) return -gamma46*b46 + delta64*a46 + a610*A410 + b610*B410;
		/*a47*/ if (j == 76) return -gamma47*a47 - delta74*b47 + a14*B17 - b14*A17 - a710*B410 + b710*A410;
		/*b47*/ if (j == 77) return -gamma47*b47 + delta74*a47 - a14*A17 - b14*B17 + a710*A410 + b710*B410;
		/*a48*/ if (j == 78) return -gamma48*a48 - delta84*b48 + a24*B28 - b24*A28 - a810*B410 + b810*A410;
		/*b48*/ if (j == 79) return -gamma48*b48 + delta84*a48 - a24*A28 - b24*B28 + a810*A410 + b810*B410;
		/*a49*/ if (j == 80) return -gamma49*a49 - delta94*b49 + a34*B39 - b34*A39 - a910*B410 + b910*A410;
		/*b49*/ if (j == 81) return -gamma49*b49 + delta94*a49 - a34*A39 - b34*B39 + a910*A410 + b910*B410;
		/*a410*/ if (j == 82) return -gamma410*a410 - delta104*b410 - B410*(a1010 - a44);
		/*b410*/ if (j == 83) return -gamma410*b410 + delta104*a410 + A410*(a1010 - a44);
		/*a411*/ if (j == 84) return -gamma411*a411 - delta114*b411 + a45*B511 + b45*A511 - a1011*B410 - b1011*A410;
		/*b411*/ if (j == 85) return -gamma411*b411 + delta114*a411 - a45*A511 + b45*B511 + a1011*A410 - b1011*B410;
		/*a412*/ if (j == 86) return -gamma412*a412 - delta124*b412 - a1012*B410 - b1012*A410;
		/*b412*/ if (j == 87) return -gamma412*b412 + delta124*a412 + a1012*A410 - b1012*B410;
		/*a56*/ if (j == 88) return -gamma56*a56 - delta65*b56 - a611*B511 + b611*A511;
		/*b56*/ if (j == 89) return -gamma56*b56 + delta65*a56 + a611*A511 + b611*B511;
		/*a57*/ if (j == 90) return -gamma57*a57 - delta75*b57 + a15*B17 - b15*A17 - a711*B511 + b711*A511;
		/*b57*/ if (j == 91) return -gamma57*b57 + delta75*a57 - a15*A17 - b15*B17 + a711*A511 + b711*B511;
		/*a58*/ if (j == 92) return -gamma58*a58 - delta85*b58 + a25*B28 - b25*A28 - a811*B511 + b811*A511;
		/*b58*/ if (j == 93) return -gamma58*b58 + delta85*a58 - a25*A28 - b25*B28 + a811*A511 + b811*B511;
		/*a59*/ if (j == 94) return -gamma59*a59 - delta95*b59 + a35*B39 - b35*A39 - a911*B511 + b911*A511;
		/*b59*/ if (j == 95) return -gamma59*b59 + delta95*a59 - a35*A39 - b35*B39 + a911*A511 + b911*B511;
		/*a510*/ if (j == 96) return -gamma510*a510 - delta105*b510 + a45*B410 - b45*A410 - a1011*B511 + b1011*A511;
		/*b510*/ if (j == 97) return -gamma510*b510 + delta105*a510 - a45*A410 - b45*B410 + a1011*A511 + b1011*B511;
		/*a511*/ if (j == 98) return -gamma511*a511 - delta115*b511 - B511*(a1111 - a55);
		/*b511*/ if (j == 99) return -gamma511*b511 + delta115*a511 + A511*(a1111 - a55);
		/*a512*/ if (j == 100) return -gamma512*a512 - delta125*b512 - a1112*B511 - b1112*A511;
		/*b512*/ if (j == 101) return -gamma512*b512 + delta125*a512 + a1112*A511 - b1112*B511;
		/*a67*/ if (j == 102) return -gamma67*a67 - delta76*b67 + a16*B17 - b16*A17;
		/*b67*/ if (j == 103) return -gamma67*b67 + delta76*a67 - a16*A17 - b16*B17;
		/*a68*/ if (j == 104) return -gamma68*a68 - delta86*b68 + a26*B28 - b26*A28;
		/*b68*/ if (j == 105) return -gamma68*b68 + delta86*a68 - a26*A28 - b26*B28;
		/*a69*/ if (j == 106) return -gamma69*a69 - delta96*b69 + a36*B39 - b36*A39;
		/*b69*/ if (j == 107) return -gamma69*b69 + delta96*a69 - a36*A39 - b36*B39;
		/*a610*/ if (j == 108) return -gamma610*a610 - delta106*b610 + a46*B410 - b46*A410;
		/*b610*/ if (j == 109) return -gamma610*b610 + delta106*a610 - a46*A410 - b46*B410;
		/*a611*/ if (j == 110) return -gamma611*a611 - delta116*b611 + a56*B511 - b56*A511;
		/*b611*/ if (j == 111) return -gamma611*b611 + delta116*a611 - a56*A511 - b56*B511;
		/*a612*/ if (j == 112) return -gamma612*a612 - delta126*b612;
		/*b612*/ if (j == 113) return -gamma612*b612 + delta126*a612;
		/*a78*/ if (j == 114) return -gamma78*a78 - delta87*b78 + a18*B17 - b18*A17 + a27*B28 - b27*A28;
		/*b78*/ if (j == 115) return -gamma78*b78 + delta87*a78 + a18*A17 + b18*B17 - a27*A28 - b27*B28;
		/*a79*/ if (j == 116) return -gamma79*a79 - delta97*b79 + a19*B17 - b19*A17 + a37*B39 - b37*A39;
		/*b79*/ if (j == 117) return -gamma79*b79 + delta97*a79 + a19*A17 + b19*B17 - a37*A39 - b37*B39;
		/*a710*/ if (j == 118) return -gamma710*a710 - delta107*b710 + a110*B17 - b110*A17 + a47*B410 - b47*A410;
		/*b710*/ if (j == 119) return -gamma710*b710 + delta107*a710 + a110*A17 + b110*B17 - a47*A410 - b47*B410;
		/*a711*/ if (j == 120) return -gamma711*a711 - delta117*b711 + a111*B17 - b111*A17 + a57*B511 - b57*A511;
		/*b711*/ if (j == 121) return -gamma711*b711 + delta117*a711 + a111*A17 + b111*B17 - a57*A511 - b57*B511;
		/*a712*/ if (j == 122) return -gamma712*a712 - delta127*b712 + a112*B17 - b112*A17;
		/*b712*/ if (j == 123) return -gamma712*b712 + delta127*a712 + a112*A17 + b112*B17;
		/*a89*/ if (j == 124) return -gamma89*a89 - delta98*b89 + a29*B28 - b29*A28 + a38*B39 - b38*A39;
		/*b89*/ if (j == 125) return -gamma89*b89 + delta98*a89 + a29*A28 + b29*B28 - a38*A39 - b38*B39;
		/*a810*/ if (j == 126) return -gamma810*a810 - delta108*b810 + a210*B28 - b210*A28 + a48*B410 - b48*A410;
		/*b810*/ if (j == 127) return -gamma810*b810 + delta108*a810 + a210*A28 + b210*B28 - a48*A410 - b48*B410;
		/*a811*/ if (j == 128) return -gamma811*a811 - delta118*b811 + a211*B28 - b211*A28 + a58*B511 - b58*A511;
		/*b811*/ if (j == 129) return -gamma811*b811 + delta118*a811 + a211*A28 + b211*B28 - a58*A511 - b58*B511;
		/*a812*/ if (j == 130) return -gamma812*a812 - delta128*b812 + a212*B28 - b212*A28;
		/*b812*/ if (j == 131) return -gamma812*b812 + delta128*a812 + a212*A28 + b212*B28;
		/*a910*/ if (j == 132) return -gamma910*a910 - delta109*b910 + a310*B39 - b310*A39 + a49*B410 - b49*A410;
		/*b910*/ if (j == 133) return -gamma910*b910 + delta109*a910 + a310*A39 + b310*B39 - a49*A410 - b49*B410;
		/*a911*/ if (j == 134) return -gamma911*a911 - delta119*b911 + a311*B39 - b311*A39 + a59*B511 - b59*A511;
		/*b911*/ if (j == 135) return -gamma911*b911 + delta119*a911 + a311*A39 + b311*B39 - a59*A511 - b59*B511;
		/*a912*/ if (j == 136) return -gamma912*a912 - delta129*b912 + a312*B39 - b312*A39;
		/*b912*/ if (j == 137) return -gamma912*b912 + delta129*a912 + a312*A39 + b312*B39;
		/*a1011*/ if (j == 138) return -gamma1011*a1011 - delta1110*b1011 + a411*B410 - b411*A410 + a510*B511 - b510*A511;
		/*b1011*/ if (j == 139) return -gamma1011*b1011 + delta1110*a1011 + a411*A410 + b411*B410 - a510*A511 - b510*B511;
		/*a1012*/ if (j == 140) return -gamma1012*a1012 - delta1210*b1012 + a412*B410 - b412*A410;
		/*b1012*/ if (j == 141) return -gamma1012*b1012 + delta1210*a1012 + a412*A410 + b412*B410;
		/*a1112*/ if (j == 142) return -gamma1112*a1112 - delta1211*b1112 + a512*B511 - b512*A511;
		/*b1112*/ if (j == 143) return -gamma1112*b1112 + delta1211*a1112 + a512*A511 + b512*B511;
    }
    //********************************************************************************//
